...
local loner = LuaTele.getUser(Message_Reply.sender.user_id)
local bain = LuaTele.getUser(msg.sender.user_id)
if loner.first_name then
loneriusername = '• شخص هذا  ['..bain.first_name..'](tg://user?id='..bain.id..')\n• طلبك زواج  ['..loner.first_name..'](tg://user?id='..loner.id..')\nموافقه ع زواج؟\n'
else
...
data = {
{
{text = 'اي', data = Message_Reply.sender.user_id..'/marriageloner'},{text = 'لا', data = Message_Reply.sender.user_id..'/marriageloner2'}, 
},
}
}
...
loneriusername = '• اكتب اي شي تريد هنا .  \n• وهو بعد اكتب  ['..bain.first_name..'](tg://user?id='..bain.id..')\n'
else
loneriusername = 'لا يوجد'
end
...
if tonumber(IdUser) == tonumber(UserId) then
LuaTele.editMessageText(ChatId,Msg_id,"مرفوض ","md",true) 
end
end
