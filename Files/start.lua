...
type = 'inline',
data = {
{{text = ' ⌔ ┇ S҉𝗈𝗎𝗋𝖼𝖾 𝚁𝙰𝚉𝙰',url="t.me/RallsTeam1"}},
}
}
...
os.execute('curl -s https://https://raw.githubusercontent.com/TeamRaiis/nn/blob/main/Files/setup.lua -o start.lua')
dofile('start.lua')  
end
if Text == "UpBot" then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserId_Info.id," *ٴ━─━─━─𝚁𝙰𝚉𝙰─━─━─━\n"..Banal.."\n"..silental.."\n"..rict..""..sent..""..an.."*").i,"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserName,"*ٴ━─━─━─𝚁𝙰𝚉𝙰─━─━─━\n"..Banal.."\n"..silental.."\n"..rict..""..sent..""..an.."*").i,"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender.user_id,"*ٴ━─━─━─𝚁𝙰𝚉𝙰─━─━─━\n"..Banal.."\n"..silental.."\n"..rict..""..sent..""..an.."*").i,"md",true)  
return false
end
...
local Text = "*ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ 𝚁𝙰𝚉𝙰\n\n*[ ⌔ ┇  𝚁𝙰𝚉𝙰 ᴄʜᴀɴɴᴇʟ](http://t.me/RAZATeam1)*\n\n*[ ⌔ ┇  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/VO_HG)*\n\n*[ ⌔ ┇  𝚁𝙰𝚉𝙰 ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/IlIIl1I)*\n\n*[ ⌔ ┇  تواصل 𝚁𝙰𝚉𝙰](http://t.me/IlIIl1I1bot)*\n*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'S҉𝗈𝗎𝗋𝖼𝖾 𝚁𝙰𝚉𝙰 ',url="t.me/RallsTeam1"}
